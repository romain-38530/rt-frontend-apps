 ...
 */
export function mapFrontendToBackend(frontendType) {
    const mapping = {
        industry: 'EXPEDITEUR',
 ...
 */
export function mapBackendToFrontend(backendType) {
 ...
 */
export function getDisplayName(backendType) {
    const displayNames = {
 ...
 */
export function getShortDisplayName(backendType) {
    const shortNames = {
 ...
 */
export function getDescription(backendType) {
    const descriptions = {
 ...
 */
export function getPortalUrl(backendType) {
    const portalUrls = {
 ...
 */
export function getIcon(backendType) {
    const icons = {
        EXPEDITEUR: '🏭',
        TRANSPORTEUR: '🚚',
 ...
 */
export function getColor(backendType) {
    const colors = {
 ...
 */
export function isDirectlyCreatable(backendType) {
 ...
 */
export function getMainFeatures(backendType) {
    const features = {
        EXPEDITEUR: [
 ...
 */
export function getAllCreatableTypes() {
    const all = [
        'EXPEDITEUR',
        'TRANSPORTEUR',
        'PLATEFORME_LOGISTIQUE',
 ...
 */
export function getAccountTypeInfo(backendType) {
    return {
        type: backendType,
 ...
 */
export function getAllCreatableTypesInfo() {
 ...
 */
export function isValidBackendAccountType(value) {
    const validTypes = [
        'TRANSPORTEUR',
        'EXPEDITEUR',
        'PLATEFORME_LOGISTIQUE',
 ...
 */
export function parseBackendAccountType(value) {
...
//# sourceMappingURL=accountTypeMapping.js.map