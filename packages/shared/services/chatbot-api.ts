...
const API_BASE_URL = process.env.NEXT_PUBLIC_CHATBOT_API_URL || 'https://de1913kh0ya48.cloudfront.net';
const WS_URL = process.env.NEXT_PUBLIC_CHATBOT_WS_URL || 'wss://de1913kh0ya48.cloudfront.net/chatbot/ws';
