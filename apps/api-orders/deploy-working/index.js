...
const ai_reports_1 = __importDefault(require("./routes/ai-reports"));
...
app.use('/api/v1/ai-reports', ai_reports_1.default);
app.use('/api/v1/palettes', palettes_1.default);
// Health check
...
app.get('/health/smtp', async (req, res) => {
    const result = await notification_service_1.default.checkSmtpConnection();
    res.json(result);
});
...
mongoose_1.default.connect(MONGODB_URI)
    ...
    ai_report_scheduler_1.default.start();
    app.listen(PORT, () => {
...
process.on('SIGTERM', () => {
    ...
    ai_report_scheduler_1.default.stop();
