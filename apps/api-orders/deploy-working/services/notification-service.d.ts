...
declare class NotificationService {
     ...
     */
    static notifyIndustrialInvoiceUploaded(industrialEmail: string, industrialName: string, preInvoiceNumber: string, carrierName: string, invoiceNumber: string, invoiceAmount: number, preInvoiceAmount: number): Promise<boolean>;
    /**
