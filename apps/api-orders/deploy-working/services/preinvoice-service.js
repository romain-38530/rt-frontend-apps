...
class PreInvoiceService {
    ...
    static async uploadCarrierInvoice(preInvoiceId, invoiceData) {
        try {
            ...
            await notification_service_1.default.notifyIndustrialInvoiceUploaded(preInvoice.industrialEmail, preInvoice.industrialName, preInvoice.preInvoiceNumber, preInvoice.carrierName, invoiceData.invoiceNumber, invoiceData.invoiceAmount, preInvoice.totals.totalTTC);
