/**
 * Palettes Order API - Suivi palettes sur commandes (Supplier)
 */
...
export const palettesOrderApi = {
  ...
  confirmPickup: async (orderId: string, data: {
    quantity: number;
    palletType: string;
    ...
    const res = await fetch(`${ORDERS_API_URL}/api/v1/palettes/${orderId}/pickup`, {
      method: 'POST',
      headers: getAuthHeaders(),
