...
import PaletteExchangeRecipient from '../../components/PaletteExchangeRecipient';
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '20px' }}>
            ...
            <div>
              ...
              {order.goods.palettes && order.goods.palettes > 0 && (
                <div style={cardStyle}>
                  <PaletteExchangeRecipient
                    orderId={order.id}
                    orderStatus={order.status}
                    palletTracking={palletTracking || undefined}
                    recipientId={order.deliveryAddress.contactName || 'recipient'}
                    recipientName={order.deliveryAddress.contactName || 'Destinataire'}
                    carrierInfo={{
                      id: 'carrier',
                      name: 'Transporteur'
                    }}
