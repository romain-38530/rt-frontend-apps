...
export default function OrdersPage() {
  ...
  const handleAction = async () => {
    setLoading(true);
    try {
      alert(`Service Mes commandes en cours d'implémentation...\n\nAPI: ${apiUrl}`);
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Mes commandes - Recipient | SYMPHONI.A</title>
      </Head>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <h1 style={{ fontSize: '24px', fontWeight: '800', margin: 0 }}>Mes commandes</h1>
            </div>
          </div>
          <div style={{
            padding: '8px 20px',
