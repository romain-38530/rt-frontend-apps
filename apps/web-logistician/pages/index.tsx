...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      desc: 'Visualisez vos KPIs logistiques en temps réel',
      locked: subscription?.tier === 'free'
    },
    {
      icon: '📦',
      title: 'Gestion des stocks',
      desc: 'Optimisez vos niveaux de stock et inventaires',
      locked: false
    },
    {
      icon: '🚚',
      title: 'Planification des transports',
      desc: 'Orchestrez vos flux logistiques efficacement',
      locked: subscription?.tier === 'free'
    },
    {
      icon: '📈',
      title: 'Analytics avancés',
      desc: 'Analyses prédictives et optimisation des coûts',
  ...
  return (
    <>
      <Head>
        <title>Logistician Portal - RT Technologie</title>
      </Head>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Pilotez votre chaîne logistique de manière optimale
            </p>
          </div>
          ...
          <div style={{
            ...
            {[
              { label: 'Opérations ce mois', value: subscription?.tier === 'free' ? '8/10' : '152' },
              { label: 'En cours', value: '34' },
              { label: 'Finalisées', value: '567' },
              { label: 'Taux d\'efficacité', value: '94%' }
            ].map((stat, i) => (
              <div key={i} style={{
