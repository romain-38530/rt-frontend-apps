  ...
  const features = [
    {
      ...
      desc: 'Orchestrez vos opérations de transit international',
      locked: subscription?.tier === 'free'
    },
    {
      icon: '📄',
      title: 'Documentation douanière',
      desc: 'Gestion complète des documents douaniers',
      locked: false
    },
    {
      icon: '🚢',
      title: 'Multi-modal',
      desc: 'Gérez tous vos modes de transport',
      locked: subscription?.tier === 'free'
    },
    {
      icon: '💼',
      title: 'Gestion des dossiers',
      desc: 'Centralisation de tous vos dossiers clients',
