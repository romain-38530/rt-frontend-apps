            ...
            <div style={{ background: 'white', borderRadius: '16px', padding: '40px', maxWidth: '400px', width: '90%', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
              ...
              {forgotSuccess ? (
                <div>
                  ...
                  <button onClick={() => { setShowForgotPassword(false); setForgotSuccess(false); setForgotEmail(''); }} style={{ width: '100%', padding: '12px', background: '#4facfe', color: 'white', border: 'none', borderRadius: '6px', fontSize: '14px', fontWeight: '600', cursor: 'pointer' }}>{t.backToLogin}</button>
                </div>
              ) : (
                <form onSubmit={handleForgotPassword}>
                  ...
                  <button type="submit" disabled={forgotLoading} style={{ width: '100%', padding: '12px', background: forgotLoading ? '#a0aec0' : '#4facfe', color: 'white', border: 'none', borderRadius: '6px', fontSize: '14px', fontWeight: '600', cursor: forgotLoading ? 'not-allowed' : 'pointer', marginBottom: '12px' }}>{forgotLoading ? t.sending : t.sendResetLink}</button>
