...
export default function TrackingPage() {
  ...
  const handleAction = async () => {
    setLoading(true);
    try {
      alert(`Service Suivi en temps réel en cours d'implémentation...\n\nAPI: ${apiUrl}`);
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Suivi en temps réel - Forwarder | SYMPHONI.A</title>
      </Head>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <h1 style={{ fontSize: '24px', fontWeight: '800', margin: 0 }}>Suivi en temps réel</h1>
            </div>
          </div>
          <div style={{
            padding: '8px 20px',
            background: 'rgba(4ECDC4, 0.2)',
            borderRadius: '20px',
            fontSize: '13px',
            fontWeight: '700'
          }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                padding: '16px 48px',
                background: loading ? '#666' : 'linear-gradient(135deg, #4ECDC4 0%, #667eea 100%)',
                color: 'white',
                border: 'none',
                borderRadius: '12px',
