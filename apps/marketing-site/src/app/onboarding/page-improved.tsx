...
export default function OnboardingPage() {
  ...
  const verifyVAT = async () => {
    ...
    try {
      ...
      const vatApiUrl = process.env.NEXT_PUBLIC_VAT_API_URL || process.env.NEXT_PUBLIC_API_URL || 'https://ddaywxps9n701.cloudfront.net';
  ...
  const submitOnboarding = async () => {
    ...
    try {
      const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'https://ddaywxps9n701.cloudfront.net';
